...
#  При добавлении товара менеджером, ему присваивается product.id, и создаётся папка с именем {product.id}
...
#
#
#  https://gist.github.com/lanfon72/0e3641c6cef3a5de75196619658d8f5b
