...
# TODO: Поправить добавление менеджера и добавить удаление менеджера
#  Добавление\убавление баланса пользователю
#  Бан пользователя
#  Изменение и добавление! товара (только админу), а добавление аккаунтов к товару (админ + менеджер)
#  Посмотреть баги удаления сообщений
#  Кодировка названий zip файлов
#  Баг с нулевой корзиной (если товара 0, то должен выдать ошибку, но вроде бы это и не баг, так как не пройдёт заказ)
#  Удалять полученные архивы после распаковки
#  Техподдержку можно сделать на кнопке ссылке (оставить пункт Помощь, но добавить кнопку с ссылкой на менеджера)
...
#       Купить x5-x10 и т.д. или ввести своё количество
#       История заказов
...
#       Удаление заказов, если прошло больше месяца, также добавить обработку этого, если запрашивается статистика
#       Реферальная система
